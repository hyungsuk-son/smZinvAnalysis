...
//  SH::ScanDir().filePattern("user.hson.14408495._000*").scan(sh,inputFilePath); // 364164.Sherpa_221_NNPDF30NNLO_Wmunu_MAXHTPTV140_280_BFilter
...
//  job.options()->setString(EL::Job::optSubmitFlags, slurmOptions);
  ...
  std::string slurmJobName = "data16";
  // No delay

...
//  job.options()->setString(EL::Job::optSubmitFlags, slurmOptions);
  ...
  //std::string slurmOptions = "-n 1 --cpus-per-task 1 --mem-per-cpu=32000 -p batch --time=2-2:00:00 --begin=now+2400 --exclude=m4lmem01,alpha027,alpha031 -o stdout.%j -e stderr.%j --mail-type=END --job-name="+slurmJobName;
